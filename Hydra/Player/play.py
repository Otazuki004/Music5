...
import aiofiles
import aiohttp
from Hydra.converter import convert
import ffmpeg
import requests
from Process.fonts import CHAT_TITLE
from PIL import Image, ImageDraw, ImageFont
from Hydra.config import ASSISTANT_NAME, BOT_USERNAME, IMG_1, IMG_2, IMG_5
...
from Hydra.inline import stream_markup, audio_markup
    ...
    if replied:
        ...
        f"**🔎Finding song**"
            ...
            if search == 0:
                ...
                gcname = m.chat.title
                videoid = search[4]
                dlurl = f"https://www.youtube.com/watch?v={videoid}"
                info = f"https://t.me/Hydra_100_bot?start=info_{videoid}"
